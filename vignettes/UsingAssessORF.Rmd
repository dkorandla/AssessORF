...
Below is an example of how to use the `AssessGenes` function, using the pre-saved mapping object for *Acinetobacter baumannii* ATCC17978 and the corresponding set of Prodigal-predicted genes.
```{r message = FALSE}
library(AssessORF)
